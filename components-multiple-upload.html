...
<head>
  ...
  <title>Components &rsaquo; Multiple Upload &mdash; Stisla</title>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link beep beep-sidebar" href="components-hero.html">Hero</a></li>                <li class=active><a class="nav-link" href="components-multiple-upload.html">Multiple Upload</a></li>
