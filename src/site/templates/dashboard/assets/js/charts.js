...
//
// ApexCharts is loaded from the CDN. Every chart reads Stisla's runtime --st-*
...
(function () {
  ...
  function salesOptions() {
    var primary = token("--st-primary");
    var danger = token("--st-danger");
    var muted = token("--st-muted-foreground");
    var border = token("--st-border");
  ...
  function heroOptions(hero) {
    var color = token(hero.color || "--st-primary");
    return {
      chart: {
        type: "area",
        height: 88,
  ...
  function categoryOptions() {
    return donutOptions(
      ...
      [44, 30, 16, 10],
      ["--st-primary", "--st-info", "--st-success", "--st-warning"],
    );
  }
  ...
  function fulfillmentOptions() {
    var primary = token("--st-primary");
    var muted = token("--st-muted-foreground");
    var foreground = token("--st-foreground");
    var track = token("--st-neutral");
