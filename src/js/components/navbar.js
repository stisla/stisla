...
//
// A thin wrapper around a single Stisla.Collapsible mounted on
// .navbar__menu, triggered by .navbar__toggle. Above the navbar's
// collapse breakpoint the toggle is display: none in CSS, so this class
// never sees clicks while the menu is permanently visible — no breakpoint
...
//
// Options:
//   duration — transition duration override, propagated to the underlying
//              Collapsible.
//
