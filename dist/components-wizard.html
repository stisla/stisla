...
<head>
  ...
  <title>Components &rsaquo; Wizard &mdash; Stisla</title>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="components-user.html">User</a></li>                <li class=active><a class="nav-link beep beep-sidebar" href="components-wizard.html">Wizard</a></li>              </ul>
            </li>
            <li class="dropdown">
